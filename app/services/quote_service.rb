  ...
  def data
    {
      ...
      deductibleFormula: deductible_formula.presence || NacebelCode::MEDIUM_DEDUCTIBLE_FORMULA_OPTION,
      coverageCeilingFormula: coverage_ceiling_formula.presence || NacebelCode::SMALL_COVERAGE_CEILING_FORMULA_OPTION
    }
  end
